...
ggplot(data, aes(x = delta_pred, y = factor(`Cardiometabolic.marker`, levels = c("Weight", "BMI", "WC", "SBP", "DBP", "TC", "HDL", "LDL", "Triglycerides", "Glucose", "HbA1c", "MetS")), color = cutpoint)) +
